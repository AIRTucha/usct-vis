  ...
  */
  ...
  function createAbout(){
    ...
    $('.about_content').append('<h1>About Us</h1><br/>' + 
                       '<p>The visualosation is created by <a target = "_blank" href = "http://ipe.kit.edu">Insitute of Data Processing and Electronics</a> of <a target = "_blank" href = "http://kit.edu">Karslruhe Instatupe of Technology</a> for <a target = "_blank" href = "http://www.ipe.kit.edu/english/167.php">Early Breast Cancer Detection with Ultrasound Computertomography project</a>.</p><br/>' +
