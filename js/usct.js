...
function Loading() {
    ...
    setTimeout(function(){ 
                 frame.animate({x:w*0.05,
                          ...
                          width:w*0.9,
                          height:window.innerHeight*0.9},1000,mina.easeinout);
