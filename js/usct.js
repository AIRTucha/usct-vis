...
},{"./loading":1,"./modes":3,"jquery":5}],3:[function(require,module,exports){
(function (global){
/**
  ...
  modesButtonGenerator([
    {
      ...
      name:'Attenuation',
      tooltip:'The model shows user distribution of areas with high and low attenuation via brightness. So, it allows to estimate the attenuation value at certain point of space.<br>Attenuation can be helpful in an identification of the particular lesion`s type',
      config:{
    ...
    },
    {
      ...
      tooltip:'The model shows user only parts of breast which have highest attenuation values and allows to look at more clear.<br>Attenuation can be helpful in an identification of the particular lesion`s type.',
      config:{
    ...
    },
    {
      image:'/imgs/sos.PNG',
      name:'Sound Speed',
      tooltip:'The model shows you distribution of areas with high and low sound spread via brightness. So, it allows to estimate the value of sound speed at certain point of space.<br>Hight sound speed points doctor to the high probability on breast cancer at the point.',
      config:{
...
},{"./tooltip":4,"jquery":5}],4:[function(require,module,exports){
/**
